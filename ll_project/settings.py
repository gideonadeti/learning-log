...
SECRET_KEY = "django-insecure-tn8i@vd6=6qor7mr+vs33yiqq9&l31b1hsm3&hbl%a0rz251h!"
...
ALLOWED_HOSTS = [
    "localhost",
    "127.0.0.1",
    "learning-log-wdpq.onrender.com",
]
...
# Tell Django to copy static assets into a path
# called `staticfiles` (this is specific to Render)
